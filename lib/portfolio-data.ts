...
export const contact = {
  email: 'shreeshamahat35@gmail.com',
  linkedin: 'https://www.linkedin.com/in/shreesha-mahat-',
  github: 'https://github.com/shreeshamahat35',
}
...
export const education = [
  {
    ...
    detail:
      'A four-year degree combining information technology and management. Currently in the 6th semester.',
    period: 'Ongoing',
    location: 'Kathmandu, Nepal',
    status: 'In Progress',
  },
  {
    school: 'KMC College, Bagbazaar',
    degree: 'Higher Secondary (+2), Science',
    detail:
      'Completed high school in the science stream, building a strong foundation in mathematics and analytical thinking.',
    period: 'Completed',
    location: 'Kathmandu, Nepal',
    status: 'Completed',
  },
...
export const skills = [
  ...
  },
  {
    ...
    items: ['Communication', 'Teamwork', 'Critical Thinking', 'Time Management', 'Adaptability'],
  },
]
...
export const certifications = [
  {
    ...
    issuer: 'KIST College of Management',
    year: 'Apr 2026',
    tags: ['Python', 'AI'],
  },
  {
    title: 'Advanced Java',
    issuer: 'IT Training Nepal Pvt. Ltd.',
    year: 'Aug 2024',
  ...
  {
    title: 'Figma Creative Training',
    issuer: 'Dursikshya Education Network',
    year: 'Dec 2024',
    tags: ['Figma', 'UI/UX'],
  },
  {
...
export const experience = [
  ...
  },
  {
    ...
    description:
      'Serving as Secretary of the BIM Club at KIST, helping coordinate activities, communication, and events for fellow Information Management students.',
    period: 'Current',
  },
]
